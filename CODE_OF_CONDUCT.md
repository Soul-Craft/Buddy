...
community a welcoming, respectful, and inclusive experience for everyone,
...
Community participants are expected to treat others professionally and
respectfully at all times. Disrespectful, demeaning, or exclusionary behavior
is not acceptable.
...
responsible for enforcement via
[GitHub Security Advisories](https://github.com/Soul-Craft/buddy-evolver/security/advisories/new)
or by opening a private contact with the maintainers. All complaints will be
...
**Impact**: Use of language or behavior considered unprofessional or unwelcome.
...
or sustained behavior harmful to the community.
